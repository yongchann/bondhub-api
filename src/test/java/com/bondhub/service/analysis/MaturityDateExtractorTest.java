...
class MaturityDateExtractorTest {
    ...
    public void t() {
        ...
        List<String> samples = List.of(
                "한화토탈에너지서비스25-1(25.02.25화, AA-) 팔자(민 3.513%, 0.24원)",
                "한화토탈에너지서비스25-1(25 02 25, 화, AA-) 팔자(민 3.513%, 0.24원)",
                "한화토탈에너지서비스25-1(25/02/25, 화, AA-) 팔자(민 3.513%, 0.24원)",
                "한화토탈에너지서비스25-1(25.2.5, 화, AA-) 팔자(민 3.513%, 0.24원)",
                "한화토탈에너지서비스25-1(25.02.05, 화, AA-) 팔자(민 3.513%, 0.24원)",
                "25.4.11(금) 유안타증권88 팔자 (민3.578/끝전.6/AA-)"
        );

        //when
        for (String sample : samples) {
            System.out.println("sample = " + sample);
            List<String> strings = extractAllMaturities(sample);
