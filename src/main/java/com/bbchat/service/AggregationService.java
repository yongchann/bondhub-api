...
public class AggregationService {
    ...
    public void aggregateChat(String date) {
        FileInfo chatFile = fileRepository.getChatFileByDate(date);
        chatProcessor.processFromRawContent(date, chatFile.getContent());
    }

    public void aggregateTransaction(String date) {
        FileInfo transactionFile = fileRepository.getTransactionFileByDate(date);
        transactionProcessor.processFromInputStream(date, transactionFile.getInputStream());
    }
//
